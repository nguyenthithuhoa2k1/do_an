            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="{{ asset('/admin/upload/'.$user->avatar) }}" class="rounded-circle" width="150" />
                            ...
                            @endif
                                ...
                                <form method="post" action=""  enctype="multipart/form-data"  class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="name" placeholder="name" class="form-control form-control-line" value="{{$user->name}}">
                                            @if($errors->has('name'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" name="email" disabled placeholder="email" class="form-control form-control-line" name="example-email" id="example-email" value="{{$user->email}}">
                                            @if($errors->has('email'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="phone"  placeholder="phone" class="form-control form-control-line" value="{{$user->phone}}">
                                            @if($errors->has('phone'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="file" name="avatar"  placeholder="avatar" class="form-control form-control-line">
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            <select name="id_country" class="form-control form-control-line">
                                                ...
                                                @foreach($countries as $country)
                                                    @if($country->id_country == $user->id_country)
